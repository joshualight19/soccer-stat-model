...
print("Initializing the Catenaccio Engine...\n")

# Load the database
df = pd.read_csv('defenders_data(Sheet1).csv')
df.columns = df.columns.str.strip()

# Print a snapshot of the roster
# print("Database loaded successfully. Current Defensive Roster:")
# print(df[['Name', 'Jumping', 'Balance', 'Height']])
...
def calculate_shutdown(row):
    if row['Model'] == 'Build Up':
          score = ((row['Buffed_Tackling'] * 0.15) + 
